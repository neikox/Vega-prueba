  ...
  >
    <div class="flex justify-between items-start gap-4 mb-4">
      <div class="flex-1 min-w-0">
        <h3 class="text-base font-semibold text-gray-900 mb-1 overflow-hidden text-ellipsis whitespace-nowrap">
          {{ audit.name }}
        </h3>
    ...
    <div class="mb-4">
      <div class="flex flex-col gap-2 mb-4">
        <div class="flex items-center gap-2 text-sm text-gray-600">
          <svg class="text-gray-400 flex-shrink-0" width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
        ...
        <div class="flex items-center gap-2 text-sm text-gray-600">
          <svg class="text-gray-400 flex-shrink-0" width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
            <path d="M4 1a1 1 0 00-1 1v12a1 1 0 001 1h8a1 1 0 001-1V5.414a1 1 0 00-.293-.707l-2.414-2.414A1 1 0 009.586 2H4zm3 3v3h3v1H7v3H6v-3H3V7h3V4h1z"/>
          </svg>
...
const progressColorClass = computed(() => {
  if (props.audit.progress === 100) return 'bg-green-500'
